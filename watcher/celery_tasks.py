...
from watcher.functions import send_a_notificatio_about_new_episode
...
def check_for_updates():
    with Session() as session:
        ...
        for serial in last_registered_episode_in_all_serials:
            ...
            last_episode_on_website = 'Сезон 7 серия '
            if last_episode_on_website != serial.last_episode:
                ...
                send_a_notificatio_about_new_episode(watching_users, notification)
